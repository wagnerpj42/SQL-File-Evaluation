...
-- -- Parsing Issue: Incorrect user comment marker (--- instead of -- in user comment before answer to q1.)
-- -- Current Handling: parses appropriately
-- -- Desired Handling: not yet determined
...
--- user comment with incorrect marker
