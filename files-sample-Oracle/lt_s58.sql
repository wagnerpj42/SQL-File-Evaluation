...
-- -- Parsing Issue: single line user comment inside submitted query
-- -- Current Handling: parses appropriately, but will fail during evaluation when newlines taken out of query string
-- -- Desired Handling: should parse appropriately, perhaps change single line user comment into multi-line /* and */ comment inside string?
...
-- be sure to add WHERE clause testing both location and close date
