...
-- -- Parsing Issue: multi-line user comment inside submitted query
-- -- Current Handling: parses appropriately, should evaluate appropriate
-- -- Desired Handling: should parse and evaluate appropriately
