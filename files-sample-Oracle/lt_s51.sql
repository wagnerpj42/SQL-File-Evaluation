...
-- -- Parsing Issue: Extra SQL statements in file before answers
-- -- Current Handling: cannot parse, error written to AAA_parse_problems.out
-- -- Desired Handling: extra SQL statements ignored
