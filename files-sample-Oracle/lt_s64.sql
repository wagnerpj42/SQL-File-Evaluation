...
-- -- Parsing Issue: Multiple SQL queries submitted for single question
-- -- Current Handling: parses appropriately, first SQL query is retained for answer, subsequent SQL queries are ignored
-- -- Desired Handling: should parse and evaluate (first SQL query only) appropriately
