...
WHERE TRANSLOCATION = 'Central' AND ACCCLOSEDDATE > TO_DATE('01-01-2018','DD-MM-YYYY');
...
SELECT ACCOPENLOCATION, ACCSTATUS, COUNT (*) AS NUMBERS
FROM ACCOUNT
...
SELECT TRANSLOCATION, AVG(T1.TRANSAMOUNT)
FROM TRANSACTION T
