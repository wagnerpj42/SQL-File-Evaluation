...
public class MySQL80DataAccessObject implements IDAO {
	...
	private boolean forTesting;				// track whether DAO is being used for JUnit testing or regular evaluation
	
	// --- constructor
	public MySQL80DataAccessObject (String hostName, String portString, String idName, String username, String password, boolean forTesting) {
