...
WHERE A.AccClosedDate >= '2017-03-01';
...
SELECT DISTINCT T.TransLocation, averageForLoc.average FROM Transaction T JOIN (
...
ORDER BY averageForLoc.average DESC;
...
SELECT DISTINCT TransLocation, locationCount.counter FROM Transaction LEFT OUTER JOIN (
