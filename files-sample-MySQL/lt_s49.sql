...
where(accopenlocation='Central' and acccloseddate >= '2017-03-01');se
...
select custid, fname, lname, transamount
...
from customer, account
where accstatus = 'Closed' or accstatus = 'Frozen' or accstatus = null;
...
select translocation, accnumber
from transaction;
